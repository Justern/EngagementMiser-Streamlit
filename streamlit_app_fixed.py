...
def get_database_engine():
    ...
    try:
        ...
        server = st.secrets.get("db_server", "ecs-sql-server-engagementmiser.database.windows.net")
        database = st.secrets.get("db_name", "ecs_tweets_db")
        username = st.secrets.get("db_username", "ecsadmin")
